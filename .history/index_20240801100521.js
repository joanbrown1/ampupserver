...
app.post('/transaction', async (req, res) => {
    try {
        ...
        const charge = await req.body.charge;
        const units = await req.body.units;

        const mailOptions = {
          from: 'no-reply@powerkiosk.ng',
          to: email, 
          subject: 'Your Electricity Recharge Token',
          html: `<p>Dear Customer,
                  <br/>Thank you for trusting us in providing you  with a seamless purchase process for your Electricity Token.
                  <br/>Details for your purchase is as below:
                  <br/>Token: ${token}. 
                  <br/>Amount: ${amount}. 
                  <br/>Charge: ${charge}. 
                  <br/>KWH: ${units}. 
                  <br/>If you have challenges with this purchase  you can reach us on the following channels:
                  <br/>Phone: <a href="tel:07073305599">0707 330 5599</a>
                  <br/>Whatsapp: 0707 330 5599
                  <br/>In-app chat
                  <br/>email: <a href="mailto:support@powerkiosk.ng">support@powerkiosk.ng</a>
                  <br/>Web: <a href="https://powerkiosk.ng">https://powerkiosk.ng</a>
                  <br/>Best regards
                  <br/>Customer care
                  </p>`
       };
...
// DELETE route to delete a admin by email
