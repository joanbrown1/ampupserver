...
router.post("/", async(req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>You have been given ${privilage} rights. Password: admin12345 <br/> To change you password login and here <a href="www.powerkiosk.ng/admin">www.powerkiosk.ng/admin</a></p>`
         };
