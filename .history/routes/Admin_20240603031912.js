...
router.post("/", async(req, res) => {
    try {
        ...
        //     html: '<p>Congratulations, your application has been successfully uploaded. <br/> Do expect us to reach you as soon as an employer indicates interest in your profile however, we would like you to know that it will be of advantage to you if you take our core competence training. <br/>This training is available to premium admins on <a href="bloomx.live">BloomX</a>. <a href="bloomx.live">BloomX</a> is a personal effectiveness platform where. <br/> This training covers critical aspect such as resume building, interview preparation, you will have a deeper understanding of teamwork, improved collaboration and office ethics. <br/> For enquiries please contact us on hr@Elitesmatch.com.  <br/><br/><br/>Best Regards. <br/> Elitesmatch Team.</p>'
        //   };
