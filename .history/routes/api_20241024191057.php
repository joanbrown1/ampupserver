...
Route::group([], function() {
    ...
    Route::put('/disco/update', [DiscoController::class, 'update']);
    Route::post('/discos/id', [DiscoController::class, 'DiscosById']);
});

Route::group([], function() {
    Route::get('/announcements', [AnnoucementController::class, 'index']);
    Route::put('/announcements/update', [AnnoucementController::class, 'update']);
});
